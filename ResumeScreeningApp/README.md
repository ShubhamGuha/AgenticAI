...
Acknowledgements
Developed with the help of Edureka training and enhanced with comments and guidance from GitHub Copilot.
...
Project Structure
- resume.py: Main application code for the Resume Screening Application.
- requirements.txt: List of dependencies required to run the application.
- .env: Environment file to store the Azure OpenAI API key.
