...
llm = Gemini(model_name="models/gemini-flash-latest", api_key=GOOGLE_API_KEY)
...
async def analyze_sales(query: str, query_history: list) -> str:
    """Send a natural language query to the ReAct agent and save the formatted response."""
...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            response = asyncio.run(analyze_sales(user_query, query_history))
